    ...
    <div>
      ...
      <div className="content-wrapper">
        <div className="left-navbar">
          <span>
            <Link className="sub-title active" to={process.env.REACT_APP_DEFAULT_URL + "lecture/subject"}>
              주제별
            </Link>
          </span>
          <span>
            <Link className="sub-title" to={process.env.REACT_APP_DEFAULT_URL + "lecture/instructor"}>
              강사별
            </Link>
          </span>
          <span>
            ...
            <div className="show-lecture-detail">
              ...
              <div className="detail-content">
                <div className="detail-sub-info">
                  ...
                  {lectureData[selectedLecture].sample_url !== null && lectureData[selectedLecture].sample_url !== "null" && lectureData[selectedLecture].sample_url !== "" ? (
                    <span>
                      : <a href={lectureData[selectedLecture].sample_url !== null ? lectureData[selectedLecture].sample_url : ""}>{lectureData[selectedLecture].sample_url}</a>
                    </span>
                  ) : null}
                </div>
                <p>
                  {lectureData[selectedLecture].intro !== null && lectureData[selectedLecture].intro !== "null" && lectureData[selectedLecture].intro !== ""
                    ? lectureData[selectedLecture].intro.split("<br/>").map((item, i) => <div key={i}>{item}</div>)
                    : ""}
                </p>
