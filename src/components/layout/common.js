...
import MypageUserFinished from "../pages/mypage/userFinished";
    ...
    return (
      <div>
        ...
        <Switch>
          ...
          <Route exact path={process.env.REACT_APP_DEFAULT_URL + "mypage/finish"} component={MypageUserFinished} />
          ...
          <Route>
            <Redirect to={process.env.REACT_APP_DEFAULT_URL} />
          </Route>
        </Switch>
        <Footer />
      </div>
